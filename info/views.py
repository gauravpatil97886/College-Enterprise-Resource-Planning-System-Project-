...
def marks_list(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            sc.save()
            sc.marks_set.create(type='I', name='CA1')
            sc.marks_set.create(type='I', name='MIDSEM')
            sc.marks_set.create(type='I', name='CA2')
            sc.marks_set.create(type='E', name='Mini Project')
            sc.marks_set.create(type='E', name='Practical Exam')
