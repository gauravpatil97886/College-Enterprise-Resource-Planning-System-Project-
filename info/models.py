...
class Marks(models.Model):
    ...
    name = models.CharField(max_length=50, choices=test_name, default='CA1')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='CA1')
                    sc.marks_set.create(name='MIDSEM')
                    sc.marks_set.create(name='CA2')
                    sc.marks_set.create(name='Mini project')
